...
public class RockPaperScissors {
    ...
    private static int valueOfElfPlayWLD;
    private static int valueOfMyPlayWLD;
    ...
    private static void scoreIndividualRoundPtOne() {
        switch (elfPlay) {
    ...
    private static void winOrLoseGame() {
        for (String roundOfRPS : roundsOfRPS) {
            elfPlay = roundOfRPS.charAt(0);
            myPlay = roundOfRPS.charAt(roundOfRPS.length() - 1);
    ...
    private static void scoreIndividualRoundPtTwo() {
        switch (elfPlay) {
            case 'A' -> valueOfElfPlay = 1;
            case 'B' -> valueOfElfPlay = 2;
            case 'C' -> valueOfElfPlay = 3;
